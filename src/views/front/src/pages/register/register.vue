<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20210504/6f5e101948464749875bc28f19675784.jpg) fixed","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px 80px","boxShadow":"0px 0 2px #DFDFDF","margin":"110px 10% 110px 0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(255,255,255,.8)","display":"flex","width":"650px","position":"relative","justifyContent":"flex-end","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#654B3C","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600"}'>基于Vue校园二手物品交易平台设计和实现注册</p></div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.container {
		position: relative;
		background: url(http://codegen.caihongy.cn/20210504/6f5e101948464749875bc28f19675784.jpg) fixed;
