...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
	  ...
	  <el-button v-if="btnAuth('ershoushangpin','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#ad978a","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/ershoushangpinAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"border":"1px solid #654B3C","minHeight":"800px","padding":"10px 0","margin":"10px 0 0","background":"#fff","flex":"1","width":"calc(100% - 270px)","order":"4"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 10px","flexWrap":"wrap","background":"#fff","display":"flex","height":"auto"}'>
			<div :style='{"border":"1px solid #654B3C","padding":"10px","margin":"10px 1.5%","overflow":"hidden","background":"#ffff","flexDirection":"column","display":"flex","width":"22%","position":"relative","height":"335px"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div v-if="item.price" :style='{"padding":"0 10px","margin":"5px","color":"#fff","background":"#654B3C","width":"60px","lineHeight":"24px","fontSize":"14px"}' class="price"><span :style='{"fontSize":"12px"}'>￥</span>{{item.price}}</div>
				<div :style='{"padding":"0 10px","lineHeight":"20px","fontSize":"14px","color":"#333"}' class="name ">{{item.shangpinmingcheng}}</div>
				<div :style='{"padding":"0 10px","order":"1","height":"20px"}'>
				...
				<div :style='{"padding":"0 10px","display":"inline-block","height":"20px"}'>
				  ...
				  <span class="text" :style='{"color":"#666","lineHeight":"1.5","fontSize":"12px"}'>{{item.zhanghao}}</span>
				</div>
				<div :style='{"padding":"0 10px","display":"inline-block","height":"20px"}'>
