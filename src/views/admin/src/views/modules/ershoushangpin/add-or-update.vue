	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="原价" prop="yuanjia">
					<el-input-number v-model="ruleForm.yuanjia" placeholder="原价" :readonly="ro.yuanjia"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="原价" prop="yuanjia">
					<el-input v-model="ruleForm.yuanjia" placeholder="原价" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../nodejsb749t7y5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
