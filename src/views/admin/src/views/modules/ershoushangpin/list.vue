<template>
	<div class="main-content" :style='{"padding":"30px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"flexWrap":"wrap","margin":"20px 0","display":"flex"}'>
					...
					<el-button class="btn18" v-if="isAuth('ershoushangpin','商品类型情况')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
						商品类型情况
					</el-button>
					<el-button class="btn18" v-if="isAuth('ershoushangpin','商品量情况')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
						商品量情况
					</el-button>
					<el-button class="btn18" v-if="isAuth('ershoushangpin','品牌占比')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xiugai13" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
						品牌占比
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- $column.hiden -->
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='true' prop="tupian" width="200" label="图片">
						<template slot-scope="scope">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="shangpinfenleiChart1" style="width:100%;height:600px;"></div>
...
//统计接口
    chartDialog1() {
      ...
      this.$nextTick(()=>{
        var shangpinfenleiChart1 = echarts.init(document.getElementById("shangpinfenleiChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                shangpinfenleiChart1.setOption(option);
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    shangpinfenleiChart1.resize();
                };
            }
        });
      })
